...
<?php
		if ($ad->get_network_property('adtype') == 'slot') {
...
?>	<tr id="advman-form-ad-format"<?php echo (($ad->get_network_property('adtype') == 'ad' || $ad->get_network_property('adtype') == 'slot') ? '' : ' style="display:none"'); ?>>
	...
	<tr id="advman-form-link-format"<?php echo (($ad->get_network_property('adtype') == 'link') ? '' : ' style="display:none"'); ?>>
	...
	<tr id="advman-form-ref_image-format"<?php echo (($ad->get_network_property('adtype') == 'ref_image') ? '' : ' style="display:none"'); ?>>
