...
<div id="advman-list-actions">
	...
	<div id="advman-list-inside">
		<div class='advman-list-action'><a href='edit.php?post_status=draft'><?php _e('Copy selected ads', 'advman'); ?></a></div>
		<div class='advman-list-action'><a href='page-new.php'><?php _e('Delete selected ads', 'advman'); ?></a></div>
	</div>
...
<?php foreach ($ads as $ad) : ?>
	<tr id='post-3' class='alternate author-self status-publish iedit' valign="top">
		...
		<td class="post-title column-title">
			<strong><a class="row-title" href="javascript:advman_set_action('edit','<?php echo $ad->id; ?>');" title="<?php printf(__('Edit the ad &quot;%s&quot;', 'advman'), $ad->name); ?>">[<?php echo $ad->id; ?>] <?php echo $ad->name; ?></a></strong>
			<div class="row-actions">
				...
				<span class='edit'><a class='submitdelete' title="<?php _e('Delete this ad', 'advman'); ?>" href="javascript:advman_set_action('delete','<?php echo $ad->id; ?>', '<?php echo $ad->name; ?>', '<?php echo $ad->network_name; ?>');" onclick=""><?php _e('Delete', 'advman'); ?></a> | </span>
