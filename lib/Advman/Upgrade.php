...
class Advman_Upgrade
{
	...
	static function upgrade_adsensem(&$data)
	{
		$version = Advman_Upgrade::_get_version($data);
	...
	static function adsensem_upgrade_ad_classes(&$data)
	{
	...
	static function adsensem_upgrade_network_classes(&$data)
	{
		$adnets = Advman_Upgrade::adsensem_get_classmap();
		$aNws = array();
	...
	static function adsensem_upgrade_ad_ids(&$data)
	{
		$ads = array();
		$nextId = 1;
		foreach ($data['ads'] as $n => $ad) {
	...
	static function adsensem_upgrade_ad_settings(&$data)
	{
		$ads = array();
		foreach ($data['ads'] as $id => $ad) {
			$ad['id'] = $id;
	...
	static function adsensem_upgrade_network_settings(&$data)
	{
	...
	static function adsensem_upgrade_settings(&$data)
	{
