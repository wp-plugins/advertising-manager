...
<?php
	...
	{
		$fontTitle = $ad->get_default('font-title');
		$fontText = $ad->get_default('font-text');
...
<tr>
	...
	<td><input type="text" name="advman-channel" style="width:200px" id="advman-channel" value="<?php echo $ad->get_default('channel'); ?>" /></td>
</tr>
<tr>
	<td><label for="advman-slot"><?php _e('Alternate URL:'); ?></label></td>
	<td><input type="text" name="advman-alt-url" style="width:400px" id="advman-alt-url" value="<?php echo $ad->get_default('alt-url'); ?>" /></td>
</tr>
</table>
</div>
<br />
