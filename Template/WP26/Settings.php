...
class Template_Settings
{
	function display($target = null)
	{
		...
		$openx = !empty($_adsensem['settings']['openx-market']) ? $_adsensem['settings']['openx-market'] : false;
		$openxCpm = !empty($_adsensem['settings']['openx-market-cpm']) ? $_adsensem['settings']['openx-market-cpm'] : '0.20';
...
<input name="adsensem-openx-market" type="checkbox" id="adsensem-openx-market" value="1"<?php echo $openx ? ' checked="checked"' : ''; ?> />
<?php _e('Optimize ads on OpenX Market by default', 'advman'); ?></label>
</fieldset>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php _e('Default floor price:', 'advman'); ?> <input type="text" name="adsensem-openx-market-cpm" value="<?php echo $openxCpm; ?>" class="small-text" /><br />
