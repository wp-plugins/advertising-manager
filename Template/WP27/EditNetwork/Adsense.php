	...
	<tr id="adsensem-form-adtype">
		...
		<td>
			<select name="adsensem-adtype" id="adsensem-adtype" onchange="adsensem_form_update(this);">
				<option<?php echo ($ad->d('adtype') == 'ad' ? ' selected="selected"' : ''); ?> value="ad"> Ad Unit</option>
				<option<?php echo ($ad->d('adtype') == 'link' ? ' selected="selected"' : ''); ?> value="link"> Link Unit</option>
				<option<?php echo ($ad->d('adtype') == 'ref_text' ? ' selected="selected"' : ''); ?> value="ref_text"> Text Referral</option>
				<option<?php echo ($ad->d('adtype') == 'ref_image' ? ' selected="selected"' : ''); ?> value="ref_image"> Image Referral</option>
			</select>
		</td>
		<td>
		</td>
...
?>	<tr id="adsensem-form-ad-format"<?php echo (($ad->d('adtype') == 'ad' || $ad->d('adtype') == 'slot') ? '' : ' style="display:none"'); ?>>
	...
	<tr id="adsensem-form-link-format"<?php echo (($ad->d('adtype') == 'link') ? '' : ' style="display:none"'); ?>>
		...
		<td>
			<select name="adsensem-linkformat" id="adsensem-linkformat" onchange="adsensem_form_update(this);">
				<optgroup id="adsensem-optgroup-horizontal" label="Horizontal">
					<option<?php echo ($ad->d('adformat') == '728x15' ? ' selected="selected"' : ''); ?> value="728x15"> 728 x 15</option>
					<option<?php echo ($ad->d('adformat') == '468x15' ? ' selected="selected"' : ''); ?> value="468x15"> 468 x 15</option>
				</optgroup>
				<optgroup id="adsensem-optgroup-square" label="Square">
					<option<?php echo ($ad->d('adformat') == '200x90' ? ' selected="selected"' : ''); ?> value="200x90"> 200 x 90</option>
					<option<?php echo ($ad->d('adformat') == '180x90' ? ' selected="selected"' : ''); ?> value="180x90"> 180 x 90</option>
					<option<?php echo ($ad->d('adformat') == '160x90' ? ' selected="selected"' : ''); ?> value="160x90"> 160 x 90</option>
					<option<?php echo ($ad->d('adformat') == '120x90' ? ' selected="selected"' : ''); ?> value="120x90"> 120 x 90</option>
				</optgroup>
			</select>
		</td>
	</tr>
	<tr id="adsensem-form-ref_image-format"<?php echo (($ad->d('adtype') == 'ref_image') ? '' : ' style="display:none"'); ?>>
		...
		<td>
			<select name="adsensem-referralformat" id="adsensem-referralformat" onchange="adsensem_form_update(this);">
				<optgroup id="adsensem-optgroup-horizontal" label="Horizontal">
					<option<?php echo ($ad->d('adformat') == '110x32' ? ' selected="selected"' : ''); ?> value="110x32"> 110 x 32</option>
					<option<?php echo ($ad->d('adformat') == '120x60' ? ' selected="selected"' : ''); ?> value="120x60"> 120 x 60</option>
					<option<?php echo ($ad->d('adformat') == '180x60' ? ' selected="selected"' : ''); ?> value="180x60"> 180 x 60</option>
					<option<?php echo ($ad->d('adformat') == '468x60' ? ' selected="selected"' : ''); ?> value="468x60"> 468 x 60</option>
				</optgroup>
				<optgroup id="adsensem-optgroup-square" label="Square">
					<option<?php echo ($ad->d('adformat') == '125x125' ? ' selected="selected"' : ''); ?> value="125x125"> 125 x 125</option>
				</optgroup>
				<optgroup id="adsensem-optgroup-vertical" label="Vertical">
					<option<?php echo ($ad->d('adformat') == '120x240' ? ' selected="selected"' : ''); ?> value="120x240"> 120 x 240</option>
				</optgroup>
			</select>
		</td>
	</tr>
...
?>	<table id="adsensem-settings-colors" width="100%">
	<tr>
		...
		<td>
			<div id="ad-color-bg" style="margin-top:1em;width:200px;background: #<?php echo ($ad->d('color-bg')) ? $ad->d('color-bg') : 'FFFFFF'; ?>;">
				<div id="ad-color-border" style="font: 10px arial, sans-serif; border: 1px solid #<?php echo ($ad->d('color-border')) ? $ad->d('color-border') : 'FF0000'; ?>" class="linkunit-wrapper">
					<div id="ad-color-title" style="color: #<?php echo ($ad->d('color-title')) ? $ad->d('color-title') : '00FFFF'; ?>; font: 11px verdana, arial, sans-serif; padding: 2px;"><b><u>Linked Title</u></b><br /></div>
					<div id="ad-color-text" style="color: #<?php echo ($ad->d('color-text')) ? $ad->d('color-text') : '000000'; ?>; padding: 2px;" class="text">Advertiser's ad text here<br /></div>
					<div id="ad-color-link" style="color: #<?php echo ($ad->d('color-link')) ? $ad->d('color-link') : '008000'; ?>; font: 10px verdana, arial, sans-serif; padding: 2px;">www.advertiser-url.com<br /></div>
